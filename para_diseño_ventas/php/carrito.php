...
?>
<main>
<a href="indexVentas.php" class="btn btn-success">VOLVER</a>
<table class="main-table">
        ...
        <?php
            ...
            $valor_id="";
                foreach ($_POST as $clave=>$valor)
                {
                    ...
                    {
                        $consulta="SELECT * from producto where id_producto='$valor'";
    ...
    <tfoot>
        ...
        <tr >
        <form action="realizarVenta.php" id="venta" method="POST">
