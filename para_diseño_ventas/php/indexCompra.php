...
?>
    <div class="seccion">
    <br>
    <form action="../php/carritoCompra.php" method="POST" name="oculto" id="oculto">
...
?>
    ...
    <script src="../js/seleccionProductos_Compra.js"></script>
    <script src="../js/mandarAlCarritoCompra.js"></script>
